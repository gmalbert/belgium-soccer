# Pitch Oracle Belgian Pro League Consumer

This repository is a thin Belgian Pro League deployment backed by
...
the **Belgian Pro League artifact pipeline** workflow. Run it manually after the initial
